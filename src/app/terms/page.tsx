...
export const metadata: Metadata = {
  title: "Terms of Service — Rebuild Learning",
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="prose prose-neutral prose-sm max-w-none space-y-6">
          ...
          <section>
            <h2 className="text-lg font-semibold text-neutral-900 mb-3">3. User Accounts</h2>
            <p className="text-neutral-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-neutral-900 mb-3">4. Payments & Pricing</h2>
            <p className="text-neutral-600 leading-relaxed">
              Paid reports are available at ₹99 per assessment or ₹999 for premium (all reports). Payments are processed via Razorpay. Prices are inclusive of applicable taxes and may be updated with notice.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-neutral-900 mb-3">5. Intellectual Property</h2>
            <p className="text-neutral-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-neutral-900 mb-3">6. Limitation of Liability</h2>
            <p className="text-neutral-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-neutral-900 mb-3">7. Termination</h2>
            <p className="text-neutral-600 leading-relaxed">
      ...
      <footer className="border-t border-neutral-200 py-8 bg-neutral-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4 text-xs">
            ...
            <Link href="/refund-policy" className="text-neutral-500 hover:text-neutral-900 transition">Refund Policy</Link>
          </div>
        </div>
      </footer>
    </div>
