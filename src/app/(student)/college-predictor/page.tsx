...
export default function CollegePredictorPage() {
  return (
    <div className="max-w-md mx-auto text-center py-16">
      ...
      <h1 className="text-xl font-bold text-neutral-900 mb-2">College Predictor</h1>
      <p className="text-sm text-neutral-500 mb-6">
        Our AI-powered college prediction tool will help you estimate your rank and college
