...
export const metadata: Metadata = {
  title: "Privacy Policy — Rebuild Learning",
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="prose prose-neutral prose-sm max-w-none space-y-6">
          ...
          <section>
            <h2 className="text-lg font-semibold text-neutral-900 mb-3">3. Data Storage & Security</h2>
            <p className="text-neutral-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-neutral-900 mb-3">4. Data Sharing</h2>
            <p className="text-neutral-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-neutral-900 mb-3">5. Cookies</h2>
            <p className="text-neutral-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-neutral-900 mb-3">7. Children&apos;s Privacy</h2>
            <p className="text-neutral-600 leading-relaxed">
