...
function loadData(): JeeData {
  ...
  const filePath = path.join(process.cwd(), "public", "data", "jee-cutoff-2025.json");
...
export async function GET(req: NextRequest) {
  ...
  // College predictor: find colleges for a given rank
  ...
  // Rank predictor: show cutoffs for selected colleges
  if (mode === "rank") {
